...
Check Tab
    ...
    #ดึงข้อมูลข้อความออกมาเพื่อนดูว่าตรงกับที่ส่งเข้าไปหรือไม่ >    product list
    ...
    #ส่งค่าเข้าไปเพื่อเป็นการตัดช่องว่างของข้อความ    >    product list
