...
Check Product In Home & Cate & Detail
    ...
    ${check_position}   Run Keyword And Return Status    Element Should Be Visible    xpath=/html/body/div/div/div/div[1]/div[6]/div[2]/div/div/div[2]/div
    Run Keyword If   ${check_position} == False
    ...    Click Element    xpath=/html/body/div/div/div/div[1]/div[6]/div[2]/div/div/div[1]/div${position_product_title_row}/div/div${position_product_title_col}/div/img
...
Open Product
    ...
    ${check scrollTo}    Run Keyword And Return Status    Wait Until Page Contains Element    Click Element    xpath=/html/body/div[1]/div/div/div[1]/div[3]/div/div[2]/div[2]/div/div[${no_product}]/div[1]
    Run Keyword If      ${check scrollTo} == True
    ...    Click Element    Click Element    xpath=/html/body/div[1]/div/div/div[1]/div[3]/div/div[2]/div[2]/div/div[${no_product}]/div[1]
    ...    ELSE    Check ScrollTo
...
Change Text   
    ...
    ...            editFile    ${index}    TC2    ${excel}.${excel_type}    PASSED    alignment_value=center     font_color=1E8449      
    ...    ELSE    editFile    ${index}    TC2    ${excel}.${excel_type}    FAILED    alignment_value=center     font_color=FF0000    
