...
Check Product In Home & Cate & Detail
    ...
    ${product_title_in_home_ws}=   Replace String     ${product_title}    ${SPACE}        ${EMPTY}     #สร้างตัวแปลขึ้นมาแล้วใช้  Replace String เผื่อทำการตัดบรรทัดโดยใช้ EMPTY แทนที่ SPACE
...
Open Product
    ...
    ${check scrollTo}    Run Keyword And Return Status    Wait Until Page Contains Element    xpath=/html/body/div[1]/div/div/div[1]/div[3]/div/div[2]/div[2]/div/div[${no_product}]/div[1]
...
Change Text   
    ...
    ...    editFile    ${index}              TC2.1    ${excel}.${excel_type}    PASSED       alignment_value=center    font_color=1E8449             
    ...    ELSE    editFile    ${index}      TC2.1    ${excel}.${excel_type}    FAILED       alignment_value=center    font_color=FF0000       
